...
DIRECTORIES := include examples helper debug libraries kernels sample sample-c++ conformance docs papers tools conformance_tests utils
...
OPENVX_CONFORMANCE_DIR = conformance_tests
