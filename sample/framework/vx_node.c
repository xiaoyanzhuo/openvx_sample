...
VX_API_ENTRY vx_status VX_API_CALL vxChooseKernelVariant(vx_node node, vx_char variantName [ VX_MAX_VARIANT_NAME ])
{
    ...
    if (ownIsValidSpecificReference(&n->base, VX_TYPE_NODE) == vx_true_e)
    {
        vx_uint32 k = 0u;
